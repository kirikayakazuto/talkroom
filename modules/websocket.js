...
//websocket.connect("ws://127.0.0.1:6082", proto_man.PROTO_JSON);
websocket.connect("ws://39.106.202.13:6082", proto_man.PROTO_JSON);
// websocket.connect("ws://127.0.0.1:6083/ws", proto_man.PROTO_BUF);
